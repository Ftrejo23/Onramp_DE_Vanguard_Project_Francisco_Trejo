...
artist_df = pd.read_csv('submissions/data/final_artist.csv')
# need to make sure release_dates gets read in as a datetime
album_df = pd.read_csv('submissions/data/final_album.csv', parse_dates=['release_date'])
track_df = pd.read_csv('submissions/data/final_track.csv')
track_feat_df = pd.read_csv('submissions/data/final_track_feat.csv')
